...
const loginUser = asyncHandler(async (req, res) => {
  ...
  const { acceessToken, refreshToken } = await generateAccessAndRefreshTokens(
    user._id
  );
...
const refreshAccessToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const { acceessToken, newRefreshToken } = await generateAccessAndRefreshTokens(user._id);
    ...
    return res
      ...
      .json(
        new ApiResponse(
          200,
          { acceessToken, refreshToken: newRefreshToken },
